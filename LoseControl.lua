...
local spellIds = {
	...
	-- ==== Conquest of Azeroth (21 custom classes) — auto-generated, see coa_flagged_for_review.txt ====
	-- Barbarian
	[520711] = CC,	-- Headbutt
	[805815] = CC,	-- Tankard Toss
	[807810] = CC,	-- Frozen Tankard
	[501053] = CC,	-- Amphibimorph
	[704591] = CC,	-- Juggernaut
	[501011] = CC,	-- Crushing Slam
	[800516] = CC,	-- Savage Smash
	[802455] = CC,	-- Savage Strike
	[501010] = CC,	-- Crush
	[800950] = CC,	-- Deathmatch
	[560532] = CC,	-- Skull Smash
	[804728] = Immune,	-- Unbreakable Grip
	[801549] = Immune,	-- Thick Skull
	[705195] = Immune,	-- Improved Barbaric Rage
	[561013] = Root,	-- Berserker Rush
	[805811] = Silence,	-- Blind Stupor
	[802792] = Silence,	-- Jawbreaker
	[800838] = Snare,	-- Breath of The North
	[705189] = Snare,	-- Broken Bones
	[501056] = Snare,	-- Ruthless Redoubt
	[707763] = Snare,	-- Spirit of the Hunt
	[806892] = Snare,	-- Maiming Spear
	-- Bloodmage
	[500126] = CC,	-- Lunge
	[804198] = CC,	-- Terrify
	[300786] = CC,	-- Hemophobia
	[681304] = CC,	-- Hemostasis
	[806310] = CC,	-- Liquify
	[801074] = CC,	-- Vestigial Muck
	[803688] = CC,	-- Scarlet Delirium
	[806177] = Immune,	-- Shadow Howl
	[800780] = Immune,	-- Shadow Craze
	[681077] = Silence,	-- Arterial Bind
	[501686] = Snare,	-- Night Hunter's Howl
	-- Chronomancer
	[804448] = CC,	-- Collapse
	[804419] = CC,	-- Stasis
	[804461] = CC,	-- Babify
	[707555] = CC,	-- Slipstream
	[801280] = CC,	-- Buy Time
	[800050] = CC,	-- Dazzled
	[806246] = Immune,	-- Spellguard: Dilation
	[806165] = Immune,	-- Temporal Focus
	[802229] = Immune,	-- Time Out!
	[706127] = Immune,	-- Improved Temporal Focus
	[806296] = Immune,	-- Ripple
	[805847] = Root,	-- Clasp of Infinity
	[706969] = Snare,	-- Chronostasis
	[801295] = Snare,	-- Slow Time
	[680971] = Snare,	-- Destabilize Time
	[706973] = Snare,	-- Backtrack
	[501846] = Snare,	-- Sands of Time
	[802790] = Snare,	-- Dimensional Divergence
	-- Cultist
	[800409] = CC,	-- Enslave Lesser Mind
	[560109] = CC,	-- Corrupt Mind
	[800354] = CC,	-- Enslave
	[805114] = CC,	-- Voidbind
	[681104] = Immune,	-- Voidborne
	[801629] = Root,	-- Cosmic Ooze
	[804056] = Silence,	-- Confuse
	[680576] = Snare,	-- Eldritch Force
	[573028] = Snare,	-- Grasp of Zek'voz
	[500704] = Snare,	-- Empire's Grasp
	[803082] = Snare,	-- Edict of Empire
	-- Felsworn
	[40506] = CC,	-- Voidblaze
	[10239] = CC,	-- Voidblaze
	[54786] = CC,	-- Voidblaze
	[560284] = CC,	-- Infernal
	[800218] = CC,	-- Voidblaze
	[805235] = CC,	-- Tyrant's Gaze
	[705101] = Immune,	-- Nether Focus
	[800211] = Immune,	-- Glaivestorm
	[555738] = Immune,	-- Fury Unleashed
	[806109] = Immune,	-- Warlock's Bane
	[804764] = Immune,	-- Legionfel Pact
	[805251] = Root,	-- Trampling Hooves
	[800203] = Silence,	-- Spellbreak
	[704371] = Snare,	-- Cripple
	[800355] = Snare,	-- Legionbreaker
	-- Guardian
	[501548] = CC,	-- Battle Rush
	[501534] = Immune,	-- Iron Guard
	[803830] = Immune,	-- Hold the Line
	[501533] = Immune,	-- Brace
	[802304] = Root,	-- Gladiator's Net
	[704418] = Silence,	-- Order In The Court
	[707715] = Silence,	-- Hammer of the Law
	[501545] = Snare,	-- Warquake
	[800319] = Snare,	-- Titanic Oath
	[803938] = Snare,	-- Standard of Valiance
	-- KnightOfXoroth
	[801067] = CC,	-- Imprison
	[804168] = CC,	-- Chains of Binding
	[520295] = Immune,	-- Burning Rage
	[503148] = Root,	-- Hellhaul
	[503367] = Silence,	-- Chainwhip
	[802347] = Snare,	-- Bouncing Blade
	[706756] = Snare,	-- Chains of Xoroth
	[802344] = Snare,	-- Pestilence of Famine
	[805671] = Snare,	-- Seeking Flame
	[704977] = Snare,	-- Enslaver
	-- Necromancer
	[804171] = CC,	-- Mortuary Bond
	[800706] = CC,	-- Ghoulify
	[803741] = CC,	-- Mass Grave
	[500341] = CC,	-- Entomb
	[503640] = CC,	-- Plague of Undeath
	[504489] = CC,	-- Command: Bonefreeze
	[501999] = CC,	-- Glacial Dagger
	[501998] = CC,	-- Ice Barrage
	[804371] = Immune,	-- Foul Invocation
	[500981] = Immune,	-- Lichborn
	[504316] = Root,	-- Command: Hook
	[704685] = Root,	-- Lingering Blight
	[501991] = Root,	-- Black Ice
	[801733] = Root,	-- Splintering Ice
	[707007] = Snare,	-- March of the Dead
	[801941] = Snare,	-- Black Hook
	[501888] = Snare,	-- Crypt Swarm
	[501980] = Snare,	-- Chill Touch
	[801739] = Snare,	-- Heartchill
	[501981] = Snare,	-- Frigid Ward
	[501982] = Snare,	-- Glacial Ward
	-- Primalist
	[706199] = CC,	-- Collapsing Cavern
	[800145] = CC,	-- Emerald Slumber
	[680964] = CC,	-- Bash
	[806143] = Immune,	-- Earth's Embrace
	[500764] = Silence,	-- Throat Clamp
	[706213] = Snare,	-- Improved Earthspine
	[807432] = Snare,	-- Seismic Grasp
	[704285] = Snare,	-- Ground Tremors
	[520745] = Snare,	-- Earthquake
	[805919] = Snare,	-- Gaze of Theradras
	[503268] = Snare,	-- Mountain Hammer
	[505157] = Snare,	-- Quake
	-- Pyromancer
	[502090] = CC,	-- Petrifying Visage
	[806148] = CC,	-- Boil
	[800807] = CC,	-- Phoenix Breath
	[805480] = CC,	-- Sunderspout
	[503229] = CC,	-- Gaze of Ysera
	[502056] = CC,	-- Meteor
	[520402] = Root,	-- Death From Above
	[805476] = Root,	-- Slagbind
	[535508] = Root,	-- Cindergrip
	[800808] = Silence,	-- Spellburn
	[805624] = Silence,	-- Burning Embers
	[805502] = Silence,	-- Scalding Brand
	[801487] = Snare,	-- Burning Spheres
	[805472] = Snare,	-- Volcanic Ground
	[805376] = Snare,	-- Apocalypse
	[502043] = Snare,	-- Slag Barrage
	[803546] = Snare,	-- Supernova
	-- Ranger
	[800359] = CC,	-- Warmaster Shot
	[704309] = CC,	-- Displacement
	[705042] = CC,	-- Counter Striker
	[807820] = CC,	-- Dust Toss
	[557333] = CC,	-- Bushwhack
	[520568] = CC,	-- Blackjack
	[803115] = CC,	-- Snatch
	[801435] = CC,	-- Knockout
	[804936] = CC,	-- Hook-Hand Strike
	[562301] = CC,	-- Befriend Beast
	[806342] = Root,	-- Ripyank
	[500071] = Silence,	-- Throatcutter Shot
	[807330] = Silence,	-- Toxic Dart
	[804725] = Snare,	-- Dismounting Shot
	[704311] = Snare,	-- Elven Quivers
	-- Reaper
	[500355] = CC,	-- Mark of Terror
	[803989] = CC,	-- Soul Shock
	[805718] = Immune,	-- Jailer's Bargain
	[800845] = Immune,	-- Limbo
	[805200] = Root,	-- Soulslam
	[705430] = Silence,	-- Anguish
	[806146] = Silence,	-- Ghastly Screech
	[807740] = Silence,	-- Sever
	[803987] = Snare,	-- Otherworldly Escape
	[705440] = Snare,	-- Improved Ghost Claw
	[805717] = Snare,	-- Requiem
	[807234] = Snare,	-- Wraith Claw
	[803985] = Snare,	-- Ghost Claw
	-- Runemaster
	[802231] = CC,	-- Traprune: Stunning Glyph
	[502658] = CC,	-- Riftgate: Prison
	[805382] = CC,	-- Palm Sigil: Earth
	[524930] = CC,	-- Ice Rune
	[706666] = CC,	-- Frost Blade
	[803010] = CC,	-- Lost Page: Thaw
	[503431] = CC,	-- Brainspill
	[704138] = CC,	-- Brainspill
	[803014] = CC,	-- Lost Page: Deep Freeze
	[503430] = CC,	-- Inscription: Permafrost
	[706363] = Immune,	-- Casting Cuffs
	[804232] = Immune,	-- Khadgar's Revenge 
	[807013] = Immune,	-- Palm Sigil: Wind
	[800308] = Root,	-- Word of Frost
	[807822] = Root,	-- Cryobrand
	[807842] = Root,	-- Glacial Rune
	[805730] = Root,	-- Sorcerer's Cage
	[572738] = Root,	-- Hoarfrost
	[802631] = Silence,	-- Silencing Rune
	[807323] = Silence,	-- Palm Sigil: Arcane
	[653264] = Snare,	-- Weapon Engraving: Ice
	[807839] = Snare,	-- Runic Tattoos: Frost
	[805381] = Snare,	-- Palm Sigil: Frost
	-- Starcaller
	[560764] = CC,	-- Celestial Impact
	[804738] = CC,	-- Siren's Song
	[805546] = CC,	-- Constellation
	[806155] = Silence,	-- Astral Armor
	[806156] = Silence,	-- Astral Armor
	[805432] = Silence,	-- Halt
	[801123] = Snare,	-- Aspect of the Cosmos
	[801996] = Snare,	-- Starshield Smash
	[800501] = Snare,	-- Stellar Drift
	[801131] = Snare,	-- Starlight
	-- Stormbringer
	[707365] = CC,	-- Overload Mechanical
	[501437] = CC,	-- Arm of Thorim
	[654545] = CC,	-- Call of the Maelstrom
	[707906] = CC,	-- Storm Alert
	[800098] = Immune,	-- Stormshield
	[705661] = Immune,	-- Invigorating Winds
	[806242] = Immune,	-- Spellguard: Windburst
	[560030] = Root,	-- Lightning Cage
	[806307] = Root,	-- Fist of Lei Shen
	[801871] = Root,	-- Thunderprison
	[501411] = Snare,	-- Stormfuse
	[501410] = Snare,	-- Volt
	[526362] = Snare,	-- Whirlpool
	[803563] = Snare,	-- Barometric Pressure
	[801873] = Snare,	-- Haven
	[802354] = Snare,	-- Haven
	[704209] = Snare,	-- Shrouding Winds
	[704211] = Snare,	-- Shrouding Winds
	[704213] = Snare,	-- Shrouding Winds
	-- SunCleric
	[804057] = CC,	-- Calming Word
	[805583] = CC,	-- Glare
	[503374] = CC,	-- Transgression
	[806121] = CC,	-- Stay of Execution
	[805629] = CC,	-- Zealotry
	[807974] = CC,	-- Sunslam
	[804254] = Immune,	-- Guidance: Safeguard
	[503520] = Immune,	-- Guidance: Intervention
	[520024] = Immune,	-- Valkyr's Calling
	[503651] = Root,	-- Solar Invocation: Revelation
	[806160] = Root,	-- Staff of the Sun
	-- Templar
	[806153] = CC,	-- Bodyslam
	[807805] = CC,	-- Divine Force
	[680984] = CC,	-- Aggramar's Will
	[801205] = CC,	-- Tranquil Circle
	[560963] = CC,	-- Shackle The Unrepentant
	[804228] = Immune,	-- Unburden
	[801455] = Immune,	-- Zeal
	[560116] = Silence,	-- Interdict
	[572769] = Snare,	-- Sacred Swing
	-- Tinker
	[807197] = CC,	-- Discombobulate!
	[560754] = CC,	-- Build: Alarm Beacon
	[801828] = CC,	-- Vanguard X-173: Onslaught
	[804673] = CC,	-- Build: Minelayer Bot
	[806224] = CC,	-- Firing Cage
	[800581] = CC,	-- Bot: C.U.R.B Stomp
	[500241] = Root,	-- Rocket Boots
	[804861] = Silence,	-- Antimagic Grenade
	[800568] = Silence,	-- Bot: Mechano Bash
	[800593] = Snare,	-- Landstrider Keys!
	[707104] = Snare,	-- Macro-Gravity Zone
	[804690] = Snare,	-- Parachute Pack
	[801389] = Snare,	-- Mechsuit: Activate Jets
	-- Venomancer
	[504362] = CC,	-- Fungify
	[504867] = CC,	-- Sepsis Bloom
	[804988] = CC,	-- Fungal Assailant
	[800877] = CC,	-- Shadra's Binding
	[560248] = CC,	-- Impale
	[800911] = CC,	-- Skitterer Form
	[707103] = CC,	-- Hate
	[806154] = Immune,	-- Burrow
	[807624] = Immune,	-- Parasite
	[803525] = Root,	-- Brood Trap
	[800879] = Root,	-- Spider Jump
	[502895] = Root,	-- Venom Spit
	[804967] = Root,	-- Organocannon
	[502894] = Root,	-- Spindlebind
	[504347] = Silence,	-- Toxic Stride
	[503181] = Snare,	-- Toxic Sludge
	[801091] = Snare,	-- Rime
	[805731] = Snare,	-- Fang Venom: Creeping Poison
	[804978] = Snare,	-- Spider's Lair
	[570123] = Snare,	-- Mantid Descent
	-- WitchDoctor
	[801678] = CC,	-- Stasis Ward
	[506634] = CC,	-- Hexing Effigy
	[501228] = CC,	-- Hexxing Strike
	[803325] = CC,	-- Hir'eek's Jinx
	[801665] = Immune,	-- Big Bad Voodoo
	[807040] = Immune,	-- Shadowstalker
	[500947] = Immune,	-- Slither
	[801680] = Immune,	-- Step of the Panther
	[801583] = Immune,	-- Bind Avatar
	[501136] = Immune,	-- Mirage
	[707209] = Immune,	-- Puppeteer's Grasp
	[806294] = Silence,	-- Spirit Shock
	[803678] = Silence,	-- Malignant Jinx
	[602220] = Snare,	-- Death Draught
	[500952] = Snare,	-- Flask of Transmogrification
	[802065] = Snare,	-- Slowness Jinx
	[505339] = Snare,	-- Shadow Effigy
	-- WitchHunter
	[802826] = CC,	-- Holy Water Tonic
	[680238] = CC,	-- Shadow Trap
	[501380] = CC,	-- Brand of the Unworthy
	[802139] = CC,	-- Darkslayer's Lantern
	[520865] = Immune,	-- Pavise
	[805770] = Immune,	-- Witching Shroud
	[802281] = Immune,	-- Infiltrate
	[802275] = Root,	-- Hunt
	[804432] = Silence,	-- Muzzle
	[500089] = Silence,	-- Subjugate
	[681445] = Silence,	-- Inquisitor's Trap
	[800161] = Snare,	-- Crippling Bolt
	[805756] = Snare,	-- Smoke Grenade
	[803333] = Snare,	-- Purified Bola Throw
	[501343] = Snare,	-- Bola Shot
	[501342] = Snare,	-- Bola Throw
	[802006] = Snare,	-- Wrangle
	[500193] = CC,	-- [Stormbringer] Stormforged Strike (conditional stun, was mistagged Talent)
}
...
local INTERRUPTS = {
	...
	-- ==== Conquest of Azeroth interrupts — VERIFY lockout durations before trusting these ====
	[802792]	= 4,	-- [Barbarian] Jawbreaker
	[561310]	= 6,	-- [Chronomancer] Desynchronization
	[804056]	= 2,	-- [Cultist] Confuse
	[805114]	= 5,	-- [Cultist] Voidbind
	[800203]	= 3,	-- [Felsworn] Spellbreak
	[704159]	= 3,	-- [Guardian] Hero's Decree
	[707704]	= 3,	-- [Guardian] Shield of Denial
	[806125]	= 3,	-- [Necromancer] Banshee's Wail
	[500764]	= 3,	-- [Primalist] Throat Clamp
	[800808]	= 5,	-- [Pyromancer] Spellburn
	[500617]	= 2,	-- [Ranger] Throatpunch
	[807740]	= 3,	-- [Reaper] Sever
	[800995]	= 2.5,	-- [Runemaster] Magic Lock
	[805432]	= 3,	-- [Starcaller] Halt
	[806153]	= 6,	-- [Templar] Bodyslam
	[807805]	= 6,	-- [Templar] Divine Force
	[805096]	= 3,	-- [Venomancer] Clasp
	[804432]	= 3,	-- [WitchHunter] Muzzle
}
